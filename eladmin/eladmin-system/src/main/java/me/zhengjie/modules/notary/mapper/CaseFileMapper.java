...
public interface CaseFileMapper extends BaseMapper<CaseFile> {
    ...
    IPage<CaseFile> findAll(@Param("criteria") CaseFileQueryCriteria criteria, Page<Object> page);

    List<CaseFile> findAll(@Param("criteria") CaseFileQueryCriteria criteria);
}