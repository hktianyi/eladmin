...
public interface CaseInfoMapper extends BaseMapper<CaseInfo> {
    ...
    IPage<CaseInfo> findAll(@Param("criteria") CaseInfoQueryCriteria criteria, Page<Object> page);

    List<CaseInfo> findAll(@Param("criteria") CaseInfoQueryCriteria criteria);
}